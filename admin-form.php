...
if(isset($_POST['asubmit']))
{
  ...
  if($photo != '')
  {
    ...
    {
      echo "<script>alert('aleready Image exist');</script>";
    }else
    {
      move_uploaded_file($path,"adminimg/".$photo);

        $aobj = new Admin();
        $condition_arr = array("admin_name"=>$name,"admin_email"=>$email,"admin_password"=>$pass,"admin_photo"=>$photo);
        $result = $aobj->insert("tbl_admin",$condition_arr);
