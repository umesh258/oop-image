...
if(isset($_POST['csubmit']))
{
    ...
    if($_FILES['photo']['name'] != '')
    {
        ...
        {
            echo "<script>alert('File is aleready Exist !');</script>";
        }else
        {
            move_uploaded_file($_FILES['photo']['tmp_name'],"categoryimg/".$photo);
            $condition=array("category_name"=>$name,"category_photo"=>$photo);
            $result = $sobj->insert("tbl_category",$condition);
            if($result > 0)
            {
                echo "<script>alert('Category Record inserted !');window.location='category-table.php';</script>";
            }
        }
    }else
    {   
            ...
            <div class="card card-primary">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" class="btn btn-danger"><a href='category-table.php'>View</a></button>
                </div>
              </form>
