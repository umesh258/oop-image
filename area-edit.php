...
$sobj = new Admin();
$eid = $_GET['eid'];
$condition_arr=array("area_id"=>$eid);
$result = $sobj->select("tbl_area","*",$condition_arr);
...
if(isset($_POST['asubmit']))
{
    $id = $_POST['id'];
    $area = $_POST['area'];
    $condition_arr = array("area_name"=>$area);
    $sobj->update("tbl_area",$condition_arr,"area_id",$id);
}
            ...
            <div class="card card-primary">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="area" value="<?php echo $area ?>" class="form-control" id="exampleInputName" placeholder="Enter name">
                  </div>
                  
                <div class="card-footer">
                  <button type="submit" name="asubmit" class="btn btn-primary">Update</button>
                  <a href='area-table.php'>View</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
